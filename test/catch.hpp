...
#    pragma
GCC diagnostic
ignored "-Wparentheses" // See #674 for details
...
#if
defined(CATCH_INTERNAL_CONFIG_CPP17_STRING_VIEW) &&
...
#if
        defined(CATCH_INTERNAL_CONFIG_CPP17_VARIANT)
&& !
...
#if
defined(CATCH_INTERNAL_CONFIG_POLYFILL_ISNAN) &&
...
#if
defined(CATCH_INTERNAL_CONFIG_TRADITIONAL_MSVC_PREPROCESSOR)
&& !
...
CATCH_REC_NEXT1(CATCH_REC_GET_END
test, next)
...
f(x)
CATCH_DEFER ( CATCH_REC_NEXT(peek, CATCH_REC_LIST1)
) ( f, peek, __VA_ARGS__ )
#define
CATCH_REC_LIST1(f, x, peek, ...
),
f(x)
CATCH_DEFER ( CATCH_REC_NEXT(peek, CATCH_REC_LIST0)
) ( f, peek, __VA_ARGS__ )
#define
...
INTERNAL_CATCH_EXPAND1(INTERNAL_CATCH_DEF
__VA_ARGS__)
...
#define
INTERNAL_CATCH_MAKE_TYPE_LIST(types)
 ...
 TestName(Ts...names) {
            \
                    ...
                    (Catch::AutoReg(Catch::makeTestInvoker(&TestFunc<Types>), CATCH_INTERNAL_LINEINFO,
                                    Catch::StringRef(), Catch::NameAndTags{
                                    names, Tags
                            }), 0)...
            };/* NOLINT */ \
...
defined(CATCH_CPP17_OR_GREATER)
#define
CATCH_INTERNAL_CHECK_UNIQUE_TYPES(...) static_assert(Catch::is_unique < __VA_ARGS__ > ,
                                                     "Duplicate type detected in declaration of template test case");
#else
#define
CATCH_INTERNAL_CHECK_UNIQUE_TYPES(...) static_assert(Catch::is_unique < __VA_ARGS__ > ::value,
                                                     "Duplicate type detected in declaration of template test case");
#endif
...
INTERNAL_CATCH_TEMPLATE_TEST_CASE_2( INTERNAL_CATCH_UNIQUE_NAME(
        ...
        ____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____F_U_N_C____), Name, Tags, __VA_ARGS__
...
TestName<CATCH_REC_LIST(INTERNAL_CATCH_REMOVE_PARENS, __VA_ARGS__)>(CATCH_REC_LIST_UD(
        INTERNAL_CATCH_TEMPLATE_UNIQUE_NAME, Name, __VA_ARGS__)
);\
            return 0;\
...
INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2( INTERNAL_CATCH_UNIQUE_NAME(
        ____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____), INTERNAL_CATCH_UNIQUE_NAME(
        ____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____F_U_N_C____), ClassName, Name, Tags, __VA_ARGS__
...
inline id performOptionalSelector(id
obj,
SEL sel
) {
if ([
...
#pragma
clang diagnostic
ignored "-Warc-performSelector-leaks"
#endif
if ([
obj respondsToSelector
: sel] )
...
#if
defined(CATCH_CONFIG_ENABLE_OPTIONAL_STRINGMAKER)
&&
defined(CATCH_CONFIG_CPP17_OPTIONAL)
...
#if
defined(CATCH_CONFIG_ENABLE_VARIANT_STRINGMAKER)
&&
defined(CATCH_CONFIG_CPP17_VARIANT)
...
#pragma
warning(disable
:4800) // Forcing result to true or false
#endif
...
.
emplaceUnscopedMessage( Catch::MessageBuilder(macroName
##_catch_sr, CATCH_INTERNAL_LINEINFO, Catch::ResultWas::Info ) << log )
...
namespace Catch {
    ...
    namespace Detail {
        ...
        inline std::string getAnnotation(Class cls,
            ...
            id
            value = performOptionalSelector(cls, sel);
            if (value)
...
// Forward deprecated interface with '+' instead of '|'
    ...
    void writeToStream(std::ostream &os) const {
        ...
        size_t
        consoleWidth = CATCH_CLARA_CONFIG_CONSOLE_WIDTH;
        size_t
        optWidth = 0;
...
//           case '>':
    ...
    value;
    m_resultCapture.
    pushScopedMessage( m_messages[index] );
    m_captured++;
}
...
//// ======================================================= ////
    ...
    CATCH_CONFIG_CPP17_STRING_VIEW
            std::string
    StringMaker<std::string_view>::convert(std::string_view
    str) {
    return
    ::Catch::Detail::stringify(std::string{
            str
    }
    );
}
...
CATCH_CONFIG_CPP17_STRING_VIEW
        std::string
StringMaker<std::wstring_view>::convert(std::wstring_view
str) {
return
...
#define
    CATCH_TEMPLATE_TEST_CASE_METHOD(className, ...)
...
#define
    CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD(className, ...)
